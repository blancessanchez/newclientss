                                ...
                                <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                    ...
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        ...
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            <li><a href="{{url('logmaster')}}" class="s-header-v2__dropdown-menu-link">LogMaster</a></li>
                                            <li><a href="{{url('payrollwizard')}}" class="s-header-v2__dropdown-menu-link">PayrollWizard</a></li>
                                            <li><a href="{{url('salesguru')}}" class="s-header-v2__dropdown-menu-link">SalesGuru</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="s-header-v2__nav-item"><a href="{{url('contactUs')}}" class="s-header-v2__nav-link">Contact</a></li>
                                    @if(Auth::guest())
