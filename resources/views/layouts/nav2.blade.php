                        ...
                        <div class="s-header-v2__navbar-col s-header-v2__navbar-col--right">
                            ...
                            <div class="collapse navbar-collapse s-header-v2__navbar-collapse" id="nav-collapse">
                                <ul class="s-header-v2__nav"> 
                                    ...
                                    <li class="s-header-v2__nav-item"><a href="about.html" class="s-header-v2__nav-link">Products</a></li>
                                    <li class="s-header-v2__nav-item"><a href="about.html" class="s-header-v2__nav-link">Services</a></li>
                                    <li class="s-header-v2__nav-item"><a href="services.html" class="s-header-v2__nav-link">About</a></li>
                                    <li class="s-header-v2__nav-item"><a href="index_portfolio.html" class="s-header-v2__nav-link">Contact</a></li>
                                    @if(Auth::guest())
                                    <li class="s-header-v2__nav-item"><a href="{{url('login')}}" class="s-header-v2__nav-link s-header-v2__nav-link--dark">Login</a></li>
                                    @else
                                    <li class="s-header-v2__nav-item"><a href="{{url('edit')}}" class="s-header-v2__nav-link s-header-v2__nav-link--dark">{{Auth::user()->acctName}}</a></li>
                                    <li class="s-header-v2__nav-item"><a href="{{url('logout')}}" class="s-header-v2__nav-link s-header-v2__nav-link--dark">Logout</a></li>
                                    @endif
                                </ul>
                            </div>
                            <!-- End Nav Menu -->
