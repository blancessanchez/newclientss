          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li>
                  <a href="{{action('ssrController@index', $product->prodId)}}" ><i class="icon-star"></i>Inquire Now</a>
                </li>
                <li>
                  <a href="{{url('/')}}" ><i class="icon-star"></i>Back</a>
                </li>
              </ul>
            </div>
            <!-- Navigation Buttons -->
...
<hr>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li>
                  <a href="{{action('ssrController@index', $product->prodId)}}" style="font-size:19px;"><!-- <i class="icon-star"></i> -->Inquire Now</a>
                </li>
                <li>
                  <a href="{{action('productController@viewSS', $product->prodId)}}" style="font-size:19px;"><!-- <i class="icon-star"></i> -->Screenshots</a>
                </li>
                <li>
                  <a href="{{url('/')}}" style="font-size:19px;"><!-- <i class="icon-star"></i> -->Back</a>
                </li>
              </ul>
            </div>
            <!-- Navigation Buttons -->
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="responsive">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <h2 style="font-size:25px;"><b>{{$product->prodDesc}}</b></h2><br>
                      <p style="font-size:19px;">{{$product->prodInfo}}</p>
                      <a  target="_blank" href="{{$product->demoLink}}" class="moreLink" style="font-size:19px;">&rarr; Demo</a>
                    </div>
                  </div>
                </div>
  ...
  <br>
@if (Auth::guest())
<div class="col-md-12"><a href="{{url('login')}}" class="btn btn-flat btn-primary">Login to see comments</a></div>
<br>
@else
<div class="col-md-12">
