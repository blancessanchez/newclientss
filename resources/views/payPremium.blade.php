 ...
 <center><h1><b>Checkout</b></h1>
      <h3>
          ...
          <ol class="breadcrumb">
              ...
              <a href="{{url('/editssr/'.$idssr->ssrId.'/'.$prodId)}}">&#10148; &nbsp System Service Request &nbsp</a>
...
<div class="container">
 ...
 Choose a percentage downpayment of your system. </b>  
    ...
    <?php 
        ...
        $ordId = $row['ordId'];
    ?>
        <form action="{{action('ssrController@bill', $ordId)}}" method="GET">
        @foreach($downpayments as $down)
            ...
            <center>
                <div class="db-wrapper">
                    ...
                    <div class="db-pricing-eleven db-bk-color-two">
                        <div class="price">
                            ...
                            <sup>₱</sup>{{$down->downpayment}}
                                    @if($down->percent==100)
                                    <small>{{$down->percent}}% Full Payment</small>
                                    @else
                                    <small>{{$down->percent}}% Downpayment</small>
                                    @endif
                        </div>
                        <div>
                        {{$down->deliverables}}
               ...
               <br> <input type="radio" name="check_list" value="{{$down->id}}" class="form-control">
                ...
                <input type="hidden" name="userid" value="{{$down->prodId }}">
            </center>
            </div>
        @endforeach
        </form>
