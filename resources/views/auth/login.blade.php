...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="{{url('/home')}}"><b>Symbol</b>Solutions</a>
  </div>
  ...
  <div class="login-box-body">
    ...
    <form id="login" action="{{action('Auth\AuthController@authenticate')}}" method="POST">
      {{ csrf_field() }}
    ...
    <!--<div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="{{url('/500')}}" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
        Facebook</a>
      <a href="{{url('/500')}}" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using
        Google+</a>
    </div>-->
    <!-- /.social-auth-links -->
    <br>
