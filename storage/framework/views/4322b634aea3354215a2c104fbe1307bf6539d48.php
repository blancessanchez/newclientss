...
<div>
    <div>
      <div >
        <img src="../public/images/logochat.png" width="100px" height="105px"/>
      </div>
       <div>
        ...
        <!-- <div class="row">
          ...
          <table>
            <tr>
              ...
              <th></th>
              <th></th>
              <th style="text-align:left;">SALES NO.: <?php echo e($bill->billId); ?></th>
            </tr>
            <tr>
              <td><b><?php echo e(Auth::user()->acctName); ?></b><br> <?php echo e(Auth::user()->email); ?> <br> <?php echo e(Auth::user()->acctContact); ?> </td>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
          ...
          <hr>
        <!--   <div>
            <p><b>CUSTOMER NAME:</b> <?php echo e(Auth::user()->acctName); ?> <br> <b>EMAIL ADDRESS:</b> <?php echo e(Auth::user()->email); ?><br><b>CONTACT:</b> <?php echo e(Auth::user()->acctContact); ?></p>
          </div> -->
          <hr>
          <table border="1px">
            <tr>
            ...
            <tr>
              <td><?php echo e($bill->item); ?></td>
              <td><?php echo e($bill->billCategory); ?></td>
              <td>P <?php echo e($bill->billAmount); ?>.00</td>
              <td>P <?php echo e($bill->billAmount); ?>.00</td>
            </tr>
          </table>
          <br><br><br><br><br><br>
          <div style="width:100%">
            ...
            <div style="width:50%">
              ...
              <p style="font-size:12px;">________________________________________________<br><?php echo e(Auth::user()->acctName); ?></p>
            </div>
          </div>
