        ...
        <div class="g-bg-color--sky-light">
            <div class="container g-padding-y-125--xs">
                <div class="g-padding-y-50--xs">
                    <h1 class="g-font-size-35--xs g-font-size-55--sm g-font-size-70--lg">We're Symbol Solutions.</h1>
                    <p class="g-font-size-22--xs g-font-size-24--md g-margin-b-0--xs">Endless Opportunities. Clever Imaginations</p>
                </div>
            </div>
        </div>
        <!--========== END PROMO BLOCK ==========-->
