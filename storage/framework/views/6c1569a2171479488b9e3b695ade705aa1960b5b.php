      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary" style="margin-left: 50px;">
            ...
            <center>
              <img class="profile-user-img img-responsive img-circle" style="vertical-align: middle;" src="public/images/<?php echo e(Auth::user()->imagePath); ?>" alt="User profile picture">
