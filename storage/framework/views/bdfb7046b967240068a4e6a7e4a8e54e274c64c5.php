 ...
 .textbox:focus {
    outline-color: #54B4AD;
             ...
             <?php echo Form::open(array('url' => 'ssrform', 'files' => 'true')); ?>
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <label for="name" style="color:black;"><b>Name </b></label>
                       <input type="text" class="textbox" name="ssrName" placeholder="Enter your name" value="<?php echo e($ssr->ssrName); ?>">
                       <p style="color:red;"><?php echo e($errors->first('ssrName')); ?></p>
                  </div>
                  <div class="form-group">

                    <label for="contact" style="color:black;"><b>Contact</b></label>
                        <input type="text"  class="textbox" name="ssrContact" placeholder="Contact Number" value="<?php echo e($ssr->ssrContact); ?>">
                          <p style="color:red;"><?php echo e($errors->first('ssrContact')); ?></p>
                  </div>
                  <div class="form-group">

                    <label for="location" style="color:black;"><b>Location</b></label>
                       <input type="text" class="textbox" name="ssrLocation" placeholder="Location" value="<?php echo e($ssr->ssrLocation); ?>">>
                       <p style="color:red;"><?php echo e($errors->first('ssrLocation')); ?></p>
                  </div>
                  <div class="form-group">

                    <label for="problem" style="color:black;"><b>Problem</b></label>
                         <textarea rows="8" cols="100" class="textbox" name="ssrProblem" placeholder="State your problem"><?php echo e($ssr->ssrProblem); ?></textarea>
                  ...
                  <div class="form-group">
                    <label for="Service Request" style="color:black;"><b>Service Request</b></label>
                       <textarea rows="8" cols="100" class="textbox" name="ssrServicereq" placeholder="What kind of system?" ><?php echo e($ssr->ssrServicereq); ?></textarea>
                         <p style="color:red;"><?php echo e($errors->first('ssrServicereq')); ?></p>
                  </div>
                    <div class="form-group">
                    <label for="Product Type" style="color:black;"><b>Product Type</b></label>
                       <?php echo Form::select('product', $array[1],$array[0] ); ?>
                ...
                <input type="hidden" name="prod" value="<?php echo e($array[1]); ?>">
