          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li>
                  <a href="<?php echo e(action('productController@viewSS', $product->prodId)); ?>" style="font-size:19px;"><!-- <i class="icon-star"></i> -->Screenshots</a>
                </li>
                <li>
                ...
                <div class="tab-pane fade in active" id="responsive">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <a  target="_blank" href="<?php echo e($product->demoLink); ?>" class="moreLink" style="font-size:19px;">&rarr; Demo</a>
                    </div>
                  </div>
                </div>
