    ...
    <?php foreach($bill as $b): ?>
          ...
          <section class="row mb30">
            <div class="col-md-12">
              ...
              <div class="col-md-2">
               ...
               <center><label>Paid Bills</label></center>
        ...
        <?php else: ?>
            <?php if($b->billCategory=='Final Payment'): ?>
              <label>All payments has been paid.</label>
              <a href="<?php echo e(action('deployController@reqMain', $b->ssrId)); ?>" class="btn btn-primary">Request System Maintenance</a>
              <table style="width: 900px; margin: auto;" class="table table-bordered table-striped">
                ...
                <tbody>                  
                    ...
                    <td><?php echo e($b->billCategory); ?></td>
