                ...
                <div class="g-fullheight--xs g-bg-position--center swiper-slide"><br><br><br>
                    ...
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white"><?php echo e($product->prodDesc); ?></h1>
                            <p class="g-font-size-15--xs g-font-size-18--sm g-color--white-opacity-light g-margin-b-5--xs"><?php echo e($product->prodInfo); ?></p>
                        </div>
                      ...
                      <!--   <a href="<?php echo e(action('productController@showProd', $product->prodId)); ?>" class="moreLink btn btn-default btn-sm">More Info</a> -->
                    </div>
                </div>
               <?php endforeach; ?>                 
            </div>
        ...
        <div class="container g-padding-y-80--xs g-padding-y-125--sm">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                    <!-- News -->
                    <a href="<?php echo e(action('productController@showProd', $product->prodId)); ?>">
                    <article>
                        ...
                        <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                            ...
                            <h3 class="g-font-size-22--xs g-letter-spacing--1"><?php echo e($product->prodDesc); ?></h3>
